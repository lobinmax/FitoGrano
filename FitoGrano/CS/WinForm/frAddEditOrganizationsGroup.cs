...
namespace FitoGrano
{
	...
	public partial class frAddEditOrganizationsGroup
	{
		public frAddEditOrganizationsGroup()
		{
			InitializeComponent();
...
#region Default Instance
		...
		private static frAddEditOrganizationsGroup defaultInstance;
		
		/// <summary>
		/// Added by the VB.Net to C# Converter to support default instance behavour in C#
		/// </summary>
		public static frAddEditOrganizationsGroup Default
		{
			get
			{
				if (defaultInstance == null)
				{
					defaultInstance = new frAddEditOrganizationsGroup();
