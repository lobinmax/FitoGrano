...
Public Class frAddEditOrganizationsGroup
...
#Region "Очистка полей"
    Private Sub txtNameOrganization_Properties_ButtonClick(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles txtNameOrganization.Properties.ButtonClick, txtEmailOrganization.Properties.ButtonClick, txtPhoneOrganization.Properties.ButtonClick
